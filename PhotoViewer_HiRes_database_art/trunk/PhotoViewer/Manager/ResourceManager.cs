...
namespace PhotoViewer.Manager.Resource
{
    public static class ResourceManager
    {
        ...
        public static void LoadContent()
        {
            ...
            //mapTex_ = Texture2D.FromStream(Browser.Instance.GraphicsDevice, assembly.GetManifestResourceStream("PhotoViewer.Resources.worldmap.jpg"));
