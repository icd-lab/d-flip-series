        ...
        public Vector2 renderTag()
        {
            ...
            if (this.tags_.Count > 0)
            {
                try
                {
                    ...
                    SystemParameter.batch_.Draw(ResourceManager.frameSquare_, new Rectangle((int)this.Strokes[strokes_.Count - 2].X, (int)this.Strokes[strokes_.Count - 2].Y, width, height), Color.Gray);
                    width = 5;
                    foreach (var tag in tags_)
                    {
